        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16 pb-12 border-b border-border-subtle">
           ...
           <div>
             ...
             <ul className="space-y-2 text-text-muted text-sm">
               ...
               <li><a href="#how-it-works" className="hover:text-brand-teal transition-colors">How It Works</a></li>
               <li><a href="#reviews" className="hover:text-brand-teal transition-colors">Testimonials</a></li>
               <li><a href="#pricing" className="hover:text-brand-teal transition-colors">Pricing</a></li>
               <li><a href="#faq" className="hover:text-brand-teal transition-colors">FAQ</a></li>
             </ul>
           </div>
           ...
           <div>
             ...
             <ul className="space-y-2 text-text-muted text-sm">
               <li>
                 <a href="https://wa.me/919879737819" target="_blank" rel="noopener noreferrer" className="hover:text-brand-teal transition-colors">
                   WhatsApp: +91 98797 37819
                 </a>
               </li>
               <li>
                 <a href="mailto:chhatralatejash@gmail.com" className="hover:text-brand-teal transition-colors">
           ...
           <div>
             ...
             <ul className="space-y-2 text-text-muted text-sm">
               ...
               <li><a href="#" className="hover:text-brand-teal transition-colors">Refund Policy</a></li>
             </ul>
           </div>
        </div>
