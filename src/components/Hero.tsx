      ...
      <div className="max-w-4xl mx-auto w-full flex flex-col items-center text-center relative z-10">
        ...
        >
           <a
            ...
            className="group flex items-center justify-center bg-brand-teal hover:bg-brand-teal/90 text-white font-bold py-4 px-8 rounded-xl text-lg transition-micro cursor-pointer w-full sm:w-auto shadow-md hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-teal focus-visible:ring-offset-2 focus-visible:ring-offset-surface-base"
          >
            <span className="flex items-center gap-2">Buy Now — ₹2,999 <ChevronRight size={20} className="group-hover:translate-x-1 transition-transform duration-200" /></span>
          </a>
          <a
            href="/#features"
            className="flex items-center justify-center bg-surface-raised hover:bg-surface-elevated border border-border-strong text-text-strong font-medium py-4 px-8 rounded-xl text-lg transition-micro cursor-pointer w-full sm:w-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-teal focus-visible:ring-offset-2 focus-visible:ring-offset-surface-base"
          >
            See What's Included
          </a>
        </motion.div>
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="flex flex-wrap justify-center gap-8 md:gap-12 text-sm md:text-base text-text-base font-medium"
        >
